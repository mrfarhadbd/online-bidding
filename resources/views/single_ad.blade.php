                            ...
                            <div class="post-comments-form">
                                ...
                                <form action="{{route('post_comments', $ad->id)}}" class="form-horizontal" method="post" enctype="multipart/form-data"> @csrf
                                    ...
                                    <div class="form-group {{ $errors->has('comment')? 'has-error':'' }}">
                                        <div class="col-sm-12">
                                            <textarea class="form-control" name="comment" rows="6" placeholder="@lang('app.write_your_comment')"></textarea>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="sell-btn-group">
                        <a href="{{route('category')}}" class="btn btn-default"><i class="fa fa-search"></i> @lang('app.browse_ads')</a>
                        <a href="{{route('create_ad')}}" class="btn btn-primary"><i class="fa fa-save"></i> @lang('app.post_an_ad')</a>
                    </div>
